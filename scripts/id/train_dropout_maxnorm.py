...
from rnn_tauid.models.combined import dropout_maxnorm
...
def main(args):
    ...
    model = dropout_maxnorm(
        shape_trk, shape_cls, shape_ffnn,
        dense_units_1=128, lstm_units_1=128,
        dense_units_2=128, lstm_units_2=64,
        dense_units_3_1=512, dense_units_3_2=512, dense_units_3_3=64)

    model.summary()

    sgd = SGD(lr=0.1, momentum=0.95, nesterov=True)
    ...
    reduce_lr = ReduceLROnPlateau(factor=0.5, patience=4, min_lr=1e-6, verbose=1)
