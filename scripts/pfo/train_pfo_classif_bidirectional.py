...
from rnn_tauid.models.combined import combined_2rnn_2final_dense_multiclass_bidirectional_stacked
...
def main(args):
    ...
    model = combined_2rnn_2final_dense_multiclass_bidirectional_stacked(
        n_classes,
        shape_1, shape_2,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lstm-units-2-1", type=int, default=24)
    parser.add_argument("--lstm-units-2-2", type=int, default=16)
