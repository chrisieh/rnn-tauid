...
def main(args):
    ...
    model = combined_2rnn_2final_dense_multiclass(
        ...
        final_dense_units_1=args.final_dense_units,
        final_dense_units_2=32,
        backwards=True
    )
    model.summary()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lstm-units-1", type=int, default=20)
    parser.add_argument("--lstm-units-2", type=int, default=20)
    parser.add_argument("--final-dense-units", type=int, default=32)
