...
ax.set_ylabel(r"$\rho( \log(p_\mathrm{T}^\mathrm{track}), S_\mathrm{RNN})$", ha="right", y=1.0)
ax.legend()
...
ax.set_ylim(-0.2, 0.2)
ax.set_xlabel("Track in sequence", ha="right", x=1.0)
ax.set_ylabel(r"$\rho\left( \log\left(|d_0|\right), S_\mathrm{RNN}\right)$", ha="right", y=1.0)
ax.legend()
ax.tick_params(axis="x", which="minor", bottom="off", top="off")
...
ax.set_ylim(-0.5, 0.5)
ax.set_xlabel("Track in sequence", ha="right", x=1.0)
ax.set_ylabel(r"$\rho\left( \log\left(|z_0 \sin\theta| \right), S_\mathrm{RNN}\right)$", ha="right", y=1.0)
...
ax.set_ylim(-0.5, 0.5)
ax.set_xlabel("Track in sequence", ha="right", x=1.0)
ax.set_ylabel(r"$\rho\left(\Delta R, S_\mathrm{RNN}\right)$", ha="right", y=1.0)
ax.legend(loc="lower right")
ax.tick_params(axis="x", which="minor", bottom="off", top="off")
